...
class Business extends Resource
{
     ...
     * @var array
     */
    public static $appends = ['totalEmailAttributes'];
    ...
    {
        if (!is_null(cache('businessTotal'.auth()->id())) && cache('businessTotal'.auth()->id()) == 0) {
    ...
    public function fields(Request $request)
    {
        return [
            ...
            HasMany::make('Business Attributes', 'attributes', BusinessAttribute::class),
        ];
    }
