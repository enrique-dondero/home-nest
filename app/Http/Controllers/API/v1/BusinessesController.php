...
class BusinessesController extends Controller
{
    ...
    {
        return new BusinessCollectionResource(Business::paginate());
    }
    ...
    public function show($id)
    {
        ...
        // Total reviews
        $totalReviews = BusinessReview::where('business_id', $business->id)->orderBy('created_at', 'desc')->get();
