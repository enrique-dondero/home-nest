...
class Business extends Model
{
    ...
    /**
     * @deprecated Evan said it should be removed.
     * @return bool
     */
    ...
    {
        return $this->hasManyThrough(BusinessAttribute::class, BusinessOptionalAttribute::class, 'business_id', 'id');
    }

    public function optionalAttributes()
    {
        return $this->belongsToMany(BusinessAttribute::class)
